...
class IcatShort1Questionnaire extends QuestionnaireTemplate {
  ...
  List<QuestionnaireQuestion> questions = [
    ...
    QuestionnaireQuestion(
      questionId: "icat004",
      text:
          "Haben Sie in den letzten 3 Monaten Ihre Online-Aktivitäten in gleicher Weise fortgesetzt, obwohl Sie deswegen Wichtiges versäumten (z.B. bei der Arbeit, in der Schule oder eine Verabredung)?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
    ...
    QuestionnaireQuestion(
      questionId: "icat005",
      text:
          "Haben Sie in den letzten 3 Monaten Ihre Online-Aktivitäten in gleicher Weise fortgesetzt, obwohl Sie deswegen finanzielle Schwierigkeiten bekamen (z.B. beim Shopping, durch In-App-Käufe oder durch den Kauf von Spielen, Add-Ons, Spielehardware, Abos, Apps)?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat006",
      text:
          "Haben Sie in den letzten 3 Monaten Ihre Online-Aktivitäten in gleicher Weise fortgesetzt, obwohl Sie deswegen eine wichtige Beziehung riskiert oder verloren haben (z.B. Partnerschaft, Freundschaft oder zu einer anderen nahestehenden Person)?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat007",
      text:
          "Haben Sie in den letzten 3 Monaten Ihre Online-Aktivitäten in gleicher Weise fortgesetzt, obwohl Sie deswegen Ihren Arbeitsplatz riskiert oder verloren, eine wichtige berufliche Aufstiegschance vertan oder Ihre Aus- bzw. Weiterbildung gefährdet haben?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat008",
      text:
          "Gab es in den letzten 3 Monaten eine Zeit, in der Sie wiederholt versuchten, vor Ihrer Familie, Ihren Freund*innen oder anderen zu verheimlichen, wie viel Zeit Sie mit Online-Aktivitäten verbrachten?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat009",
      text:
          "Haben Sie in den letzten 3 Monaten mehrfach ohne Erfolg versucht, bestimmte Online-Aktivitäten ganz zu beenden oder die Nutzungszeit einzuschränken, da Sie fanden, dass Sie zu viel online sind? ",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat010",
      text:
          "Haben Sie in den letzten 3 Monaten den anhaltenden Wunsch verspürt, bestimmte Online-Aktivitäten ganz zu beenden oder die Nutzung einzuschränken, da Sie fanden, dass Sie zu viel online sind?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat011",
      text: "Haben Sie in den letzten 3 Monaten bemerkt, dass Sie aufgrund der Online-Aktivitäten Ihr Interesse an anderen Aktivitäten wie Sport, Hobbys oder Treffen mit Freund*innen verloren haben? ",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat012",
      text:
          "Hatten Sie in den letzten 3 Monaten Phasen, in denen Sie sehr viel Zeit damit verbrachten, an Ihre Online-Aktivitäten zu denken, während Sie über andere Dinge hätten nachdenken oder andere Dinge tun sollen? ",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat013",
      text: "Gab es in den letzten 3 Monaten eine Zeit, in der Sie Online-Aktivitäten oftmals dazu benutzten, um vor negativen Gefühlen (z.B. Hilflosigkeit, Schuld, Angst) zu fliehen? ",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat014",
      text:
          "Haben Sie in den letzten 3 Monaten Ihre Online-Aktivitäten in gleicher Weise fortgesetzt, obwohl Sie deswegen psychische Probleme bekamen (z.B. Depressionen, Angstzustände, Schlafprobleme, o.Ä.)?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat015",
      text:
          "Haben Sie in den letzten 3 Monaten Ihre Online-Aktivitäten in gleicher Weise fortgesetzt, obwohl sie körperliche Probleme verursachten oder verschlimmerten (z.B. Rücken-, Augen- oder Kopfschmerzen, Gelenkprobleme, deutliches Über- oder Untergewicht)?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat016",
      text: "Haben Sie in den letzten 3 Monaten an sich bemerkt, dass Sie deutlich länger oder häufiger als früher Online-Aktivitäten nutzen mussten, um genauso zufrieden zu sein wie üblich?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat017",
      text:
          "Als Sie in den letzten 3 Monaten einmal weniger oder gar nicht online aktiv sein durften oder wollten, bemerkten Sie da irgendwelche körperlichen oder psychischen Probleme (z.B. Unruhe, Angstgefühle, Nervosität, Gereiztheit, Traurigkeit)?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
    ...
    QuestionnaireQuestion(
      questionId: "icat018",
      text: "Sind Sie in den letzten 3 Monaten ins Internet gegangen, um solche Probleme von vornherein zu vermeiden?",
      type: AnswerFieldType.RADIOGROUP,
      answerOptions: [
        AnswerOption(label: "Ja", value: 1),
        AnswerOption(label: "Nein", value: 0),
